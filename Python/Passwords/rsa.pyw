...
def encrypt():
    ...
    if password.get("2.0", "end-1c") != "":
        ...
        if language == "English":
            ...
            messagebox.showerror("Error", "Por favor ingrese una sola línea")
            ...
            messagebox.showerror(
                "Error", "Пожалуйста, введите только одну строку")
        elif language == "Chinese":
            messagebox.showerror("Error", "请输入一行")
        elif language == "Japanese":
            messagebox.showerror("Error", "1行だけを入力してください")
        elif language == "Korean":
            messagebox.showerror("Error", "한 줄만 입력하십시오")
        else:
            messagebox.showerror("Error", "Please enter only one line")
        return
    if password.get("1.0", "end-1c") == "":
        ...
        if language == "English":
            ...
            messagebox.showerror("Error", "Пожалуйста, введите пароль")
        elif language == "Chinese":
            messagebox.showerror("Error", "请输入密码")
        elif language == "Japanese":
            messagebox.showerror("Error", "パスワードを入力してください")
        elif language == "Korean":
            messagebox.showerror("Error", "비밀번호를 입력하십시오")
        else:
            messagebox.showerror("Error", "Please enter a password")
        return
    if int(number.get()) > 16384 and int(number.get()) < 65536:
        ...
        if language == "English":
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Esto tomará aproximadamente 4 horas para completar")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Questo richiederà circa 4 ore per completare")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Isso levará cerca de 4 horas para concluir")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Это займет около 4 часов")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "سيستغرق هذا حوالي 4 ساعات")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
        ...
        if language == "English":
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Esto tomará aproximadamente 4 días para completar")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Questo richiederà circa 4 giorni per completare")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Isso levará cerca de 4 dias para concluir")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Это займет около 4 дней")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "سيستغرق هذا حوالي 4 أيام للانتهاء")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
        ...
        if language == "English":
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Esto tomará aproximadamente 40 segundos para completar")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Questo richiederà circa 40 secondi per completare")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Isso levará cerca de 40 segundos para concluir")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "Это займет около 40 секунд")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
            ...
            messageBoxResponse = messagebox.askyesno(
                "Warning", "سيستغرق هذا حوالي 40 ثانية للانتهاء")
            if messageBoxResponse == True:
                pass
            elif messageBoxResponse == False:
                return
...
def save_settings(languageChoice):
    ...
    if languageChoice == "English":
        ...
        hello_label = ttk.Label(monty, text="Introduzca una contraseña:",
                                name="hello_label").grid(column=0, row=2, sticky='W')
        button_thing = Label(monty, text="Elija una opción de bits (por encima de 4096 no se recomienda. Por encima de 16384 tardará mucho tiempo):                                                      ").grid(
            column=0, row=4, sticky='W')
        ...
        decrypt_button = toolbar.add_command(
            label="Déchiffrer", command=decrypt)
        ...
        settings_button = toolbar.add_command(
            label="Paramètres", command=settings)
        hello_label = ttk.Label(monty, text="Entrez un mot de passe:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(
            monty, text="Choisissez une option de bits (au-dessus de 4096 non recommandé. Au-dessus de 16384 prendra beaucoup de temps):  ").grid(column=0, row=4, sticky='W')
        ...
        # add new widgets to toolbar
        encrypt_button = toolbar.add_command(
            label="Verschlüsseln", command=encrypt)
        decrypt_button = toolbar.add_command(
            label="Entschlüsseln", command=decrypt)
        ...
        hello_label = ttk.Label(monty, text="Geben Sie ein Passwort ein:",
                                name="hello_label").grid(column=0, row=2, sticky='W')
        button_thing = Label(
            monty, text="Wählen Sie eine Bit-Option (über 4096 nicht empfohlen. Über 16384 wird viel Zeit benötigen):                                                        ").grid(column=0, row=4, sticky='W')
        ...
        hello_label = ttk.Label(monty, text="Inserisci una password:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="Scegliere un'opzione di bit (oltre 4096 non raccomandato. Oltre 16384 richiederà molto tempo):                                                       ").grid(
            column=0, row=4, sticky='W')
        ...
        settings_button = toolbar.add_command(
            label="Configurações", command=settings)
        hello_label = ttk.Label(monty, text="Insira uma senha:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="Escolha uma opção de bits (acima de 4096 não recomendado. Acima de 16384 levará muito tempo):                                                        ").grid(
            column=0, row=4, sticky='W')
        ...
        # add new widgets to toolbar
        encrypt_button = toolbar.add_command(
            label="Шифровать", command=encrypt)
        decrypt_button = toolbar.add_command(
            label="Дешифровать", command=decrypt)
        ...
        hello_label = ttk.Label(monty, text="Введите пароль:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="Выберите опцию бит (более 4096 не рекомендуется. Более 16384 потребует много времени):                                                        ").grid(
            column=0, row=4, sticky='W')
        ...
        hello_label = ttk.Label(monty, text="输入密码:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="选择位选项（4096以上不建议。 16384以上需要很长时间）：                                                                 ").grid(
            column=0, row=4, sticky='W')
        ...
        hello_label = ttk.Label(monty, text="パスワードを入力してください：", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="ビットオプションを選択してください（4096以上は推奨されません。 16384以上は時間がかかります）：                                                                 ").grid(
            column=0, row=4, sticky='W')
        ...
        hello_label = ttk.Label(monty, text="암호를 입력하십시오:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="비트 옵션을 선택하십시오（4096 이상은 권장되지 않습니다. 16384 이상은 시간이 오래 걸립니다）：                                                                 ").grid(
            column=0, row=4, sticky='W')
        ...
        settings_button = toolbar.add_command(
            label="الإعدادات", command=settings)
        hello_label = ttk.Label(monty, text="أدخل كلمة المرور:", name="hello_label").grid(
            column=0, row=2, sticky='W')
        button_thing = Label(monty, text="اختر خيار البت（لا توصي بأكثر من 4096. يستغرق 16384 أكثر من الوقت）：                                                                 ").grid(
            column=0, row=4, sticky='W')
